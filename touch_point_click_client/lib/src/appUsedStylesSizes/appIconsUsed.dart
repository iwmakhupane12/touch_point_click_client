...
class AppIconsUsed {
  ...
  static Icon closedLock = Icon(
    Icons.lock_outlined,
    color: Colors.black,
  );

  static Icon openLock = Icon(
    Icons.lock_open,
    color: Colors.black,
  );
  ...
  static Icon workIcon = Icon(
    Icons.work_outline_outlined,
    color: Colors.black,
  );

  static Icon otherIcon = Icon(
    Icons.location_searching_outlined,
    color: Colors.black,
  );

  static Icon favouriteTrue = Icon(
    Icons.favorite,
    color: Colors.red,
    size: 24.0,
  );

  static Icon favouriteFalse = Icon(
    Icons.favorite_outline,
    color: Colors.grey,
    size: 24.0,
  );

  static Icon greyRatingStar = Icon(
    Icons.star_rounded,
    size: 15.0,
    color: Colors.grey[600],
  );

  static Icon yellowRatingStar = Icon(
    Icons.star_rounded,
    size: 18.0,
    color: Colors.yellow,
  );
  ...
  static Icon drawerCircularPersonIcon = Icon(
    Icons.account_circle_outlined,
    color: Colors.black,
    size: 30,
  );

  static Icon drawerPromotions = Icon(
    Icons.card_giftcard_outlined,
    color: Colors.black,
    size: 30,
  );

  static Icon drawerRequestsIcon = Icon(
    Icons.access_time_rounded,
    color: Colors.black,
    size: 30,
  );

  static Icon drawerSupportIcon = Icon(
    Icons.support_agent_outlined,
    color: Colors.black,
    size: 30,
  );

  static Icon drawerAboutIcon = Icon(
    Icons.help_outline_sharp,
    color: Colors.black,
    size: 30,
  );

  static Icon drawerLogoutIcon = Icon(
    Icons.logout,
    color: Colors.black,
    size: 30,
  );
  ...
  static Icon iosForwardArrow = Icon(
    Icons.arrow_forward_ios_outlined,
    color: Colors.black,
    size: 24,
  );

  static Icon iosForwardArrowWhite = Icon(
    Icons.arrow_forward_ios_outlined,
    color: Colors.white,
    size: 24,
  );
  ...
  static Icon locationPinLarge = Icon(
    Icons.location_on_outlined,
    size: 30,
    color: Colors.red,
  );

  static Icon promoCode = Icon(
    Icons.card_giftcard_outlined,
    size: 30,
    color: Colors.pink,
  );
